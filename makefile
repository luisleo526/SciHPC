...
CPPFLAGS               = -std=c++23 -fopenmp -Wall -Wextra    # helpful for writing better code (behavior-related)
...
ifeq ($(SRC_CXX),)              # C program
	@read -p "Enter main file:" mainfile;\
	$(LINK.c)   $$mainfile $(OBJS) $(EXTRA_LDFLAGS) -o $@
	@echo Type ./$@ to execute the program.
else                            # C++ program
	@read -p "Enter main file:" mainfile;\
	$(LINK.cxx) $$mainfile $(OBJS) $(EXTRA_LDFLAGS) -o $@
	@echo Type ./$@ to execute the program.
endif
