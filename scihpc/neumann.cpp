        ...
        for (int j = 0; j < f->ny; j++) {
            ...
            for (int i = 1; i <= f->ghc; ++i) {
                f->data[index.i + i][index.j][index.k] =
                        f->data[index.i + i - 1][index.j][index.k] + df * h;
            }
        }
    }
}
        ...
        for (int i = 0; i < f->nx; i++) {
            ...
            for (int j = 1; j <= f->ghc; ++j) {
                f->data[index.i][index.j + j][index.k] =
                        f->data[index.i][index.j + j - 1][index.k] + df * h;
            }
        }
    }
}
        ...
        for (int i = 0; i < f->nx; i++) {
            ...
            for (int k = 1; k <= f->ghc; ++k) {
                f->data[index.i][index.j][index.k + k] =
                        f->data[index.i][index.j][index.k + k - 1] + df * h;
            }
        }
    }
}
    ...
    for (int k = 0; k < f->nz; k++) {
        for (int j = 0; j < f->ny; j++) {
            ...
            for (int i = 1; i <= f->ghc - 1; ++i) {
                f->data[index.i - i][index.j][index.k] = f->data[index.i - i + 1][index.j][index.k] - df * h;
            }
        }
    }
}
    ...
    for (int k = 0; k < f->nz; k++) {
        for (int i = 0; i < f->nx; i++) {
            ...
            for (int j = 1; j <= f->ghc - 1; ++j) {
                f->data[index.i][index.j - j][index.k] = f->data[index.i][index.j - j + 1][index.k] - df * h;
            }
        }
    }
}
    ...
    for (int j = 0; j < f->ny; j++) {
        for (int i = 0; i < f->nx; i++) {
            ...
            for (int k = 1; k <= f->ghc - 1; ++k) {
                f->data[index.i][index.j][index.k - k] = f->data[index.i][index.j][index.k - k + 1] - df * h;
            }
        }
    }
}
